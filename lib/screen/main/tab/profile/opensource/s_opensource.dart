...
import 'package:military1km/common/util/local_json.dart';
import 'package:military1km/screen/main/tab/profile/opensource/vo_package.dart';
...
class _OpensourceScreenState extends State<OpensourceScreen> {
  ...
  void initData() async {
    final list =
        await LocalJson.getObjectList<Package>("assets/json/licenses.json");
    setState(() {
      packageList = list;
    });
  }
