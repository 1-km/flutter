...
class AppColors {
  ...
  static const Color blueGreen = Color.fromARGB(255, 0, 0, 0);
  static const Color green = Color(0xFFC2FF49);
  ...
  static const Color ibori = Color(0xffF1E1B8);
  static const Color sora = Color(0xff69AEFF);
}
